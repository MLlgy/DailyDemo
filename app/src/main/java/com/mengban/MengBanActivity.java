...
public class MengBanActivity extends Activity implements AbsListView.OnScrollListener {
            ...
            mListView.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    mListView.post(new Runnable() {
                        @Override
                        public void run() {
                            new NewbieGuideManager(MengBanActivity.this, NewbieGuideManager.TYPE_LIST).addView(view.getChildAt(0)
    ...
    class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null) {
                ...
                convertView = View.inflate(MengBanActivity.this, R.layout.item, null);
