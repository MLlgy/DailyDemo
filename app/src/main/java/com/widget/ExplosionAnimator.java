...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = IconBangUtil.dp2Px(5);
    private static final float Y = IconBangUtil.dp2Px(20);
    private static final float V = IconBangUtil.dp2Px(2);
    private static final float W = IconBangUtil.dp2Px(1);
