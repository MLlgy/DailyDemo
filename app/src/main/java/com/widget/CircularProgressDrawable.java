...
import static com.widget.CircularProgressBarUtils.checkNotNull;
import static com.widget.CircularProgressBarUtils.checkPositiveOrZero;
import static com.widget.CircularProgressBarUtils.checkSpeed;
import static com.widget.CircularProgressBarUtils.getAnimatedFraction;
...
public class CircularProgressDrawable
    ...
    private CircularProgressDrawable(int[] colors, float borderWidth, float sweepSpeed,
                                     float rotationSpeed, int minSweepAngle, int maxSweepAngle,
                                     Style style, Interpolator angleInterpolator,
    ...
    public static class Builder {
        ...
        private void initValues(Context context, boolean editMode) {
            ...
            if (editMode) {
                ...
                mColors = new int[]{ContextCompat.getColor(context, R.color.blue2)};
                mMinSweepAngle = 100;
                mMaxSweepAngle = 300;
            }
        ...
        public CircularProgressDrawable build() {
            return new CircularProgressDrawable(mColors, mStrokeWidth, mSweepSpeed, mRotationSpeed,
                    mMinSweepAngle, mMaxSweepAngle, mStyle,
                    mAngleInterpolator, mSweepInterpolator);
        }
    }
}