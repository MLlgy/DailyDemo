...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    private void setUpData() {
        ...
        arrayWheelAdapter.setTextColor(R.color.split_line_color);
    ...
    private void updateCities() {
        ...
        // 设置可见条目数量
        cityWheel.setTextColor(Color.parseColor("#FFB032"));
    ...
    private void updateAreas() {
        ...
        // 设置可见条目数量
        districtWheel.setTextColor(R.color.split_line_bootom_color);
